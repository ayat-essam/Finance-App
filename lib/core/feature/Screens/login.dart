...
import 'package:finance/core/feature/verfy%20otp/verfy%20OTP%20Scr.dart';
...
import 'package:finance/core/widgets/primary%20Button%20Widget.dart';
import 'package:finance/core/feature/Screens/register.dart';
import 'package:finance/core/widgets/socialMedia%20Icons.dart';
              ...
              Column(
                ...
                children: [
                  ...
                  CustomTextField(
                    validator: (value) {
                    if(value!.length < 8){
                      return " sorry your mail must be at least 8 characters";
                    }
                    } ,
                    controller: password,
                  ...
                  PrimaryButton(
                      onPress: (){
                        if(formKey.currentState!.validate()){
                          ...
                          Navigator.push(context,
                              MaterialPageRoute(builder: (context) =>  BottemNavigationBar(userName: '',),));
                        }
